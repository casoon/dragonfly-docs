...
.nav-hover-menu-components-section {
  margin-bottom: 20px;
}

.nav-hover-menu-components-grid {
  display: grid;
  grid-template-columns: repeat(3, 1fr);
  gap: 8px;
}

.nav-hover-menu-component-item {
  display: block;
  padding: 8px 12px;
  border-radius: 6px;
  background-color: var(--vp-c-bg-soft);
